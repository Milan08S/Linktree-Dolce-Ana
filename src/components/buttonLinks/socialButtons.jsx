...
import thumbnail from '../../assets/image-730.webp';

const SocialButtons = () => {
  return (
    <div id="social-buttons">
        <a href="https://www.instagram.com/dolce_ana18/" className="social-button" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://www.tiktok.com/@dolce_ana18" className="social-button" target="_blank" rel="noopener noreferrer">
